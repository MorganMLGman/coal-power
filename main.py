...
if __name__ == "__main__":
  main()
# %%
def cuttingZeroCount(data: pd.DataFrame, column: str):
    ...
    for i in range(1, max):
        if (new_data[i-1] < 0 and new_data[i+1] > 0) or (new_data[i-1] > 0 and new_data[i+1] < 0):
            counter = counter + 1
            points.append(i)
...
x1, x2 = cuttingZeroCount(data, "ch5")
print(x1)
# %%
